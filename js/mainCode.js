...
//Create a container for everything with the centre in the middle 位于中心的容器
...
append("svg:image")
	...
	.attr("y", -ImageWidth)
	.attr("class", "sun")
	.attr("xlink:href", "img/sun.png") // 太阳图片
...
var colorScale = d3.scale.linear() // 创建线性关系，温度对应颜色，使用 d3.scale.linear
